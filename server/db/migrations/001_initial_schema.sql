...
CREATE TABLE `material_upload_record`  (
  ...
  `title` varchar(100) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NOT NULL COMMENT '材料标题',
  `text_content` text CHARACTER SET utf8mb4 COLLATE ${COLLATION} NOT NULL COMMENT '材料原文',
  `voice` varchar(50) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NOT NULL DEFAULT 'en-US-AriaNeural' COMMENT '朗读音色',
  `is_public` tinyint(1) NOT NULL DEFAULT 1 COMMENT '是否公开: 0不公开 1公开',
  `status` varchar(20) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NOT NULL DEFAULT 'processing' COMMENT '状态: processing/success/failed',
  `error_message` varchar(500) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL DEFAULT NULL COMMENT '失败原因',
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = ${COLLATION} ROW_FORMAT = Dynamic;
...
CREATE TABLE `media`  (
  ...
  `type` varchar(20) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NOT NULL COMMENT '类型: segment_audio/vocab_audio/word_audio/recording/cover/tts/user_material',
  `storage_type` varchar(10) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NOT NULL DEFAULT 'oss' COMMENT '存储方式: oss/local',
  `bucket` varchar(100) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL DEFAULT NULL COMMENT 'OSS bucket',
  `object_key` varchar(1024) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NOT NULL COMMENT 'OSS对象键或本地路径',
  `original_name` varchar(255) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL DEFAULT NULL COMMENT '原始文件名',
  `mime_type` varchar(100) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL DEFAULT NULL COMMENT 'MIME类型，如 audio/mpeg',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 291 CHARACTER SET = utf8mb4 COLLATE = ${COLLATION} ROW_FORMAT = Dynamic;
...
CREATE TABLE `recording`  (
  ...
  `feedback` text CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL COMMENT 'AI整体评价建议',
  `recognizedText` text CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL COMMENT 'AI识别出的用户实际朗读文本',
  ...
  `rawResult` text CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL COMMENT 'SDK评测原始响应JSON',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 45 CHARACTER SET = utf8mb4 COLLATE = ${COLLATION} ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `segment`  (
  ...
  `title` varchar(100) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NOT NULL COMMENT '片段标题',
  `textContent` text CHARACTER SET utf8mb4 COLLATE ${COLLATION} NOT NULL COMMENT '英文原文，四阶段核心素材',
  `translation` text CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL COMMENT '中文翻译，辅助理解',
...
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8mb4 COLLATE = ${COLLATION} ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `unit`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `title` varchar(100) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NOT NULL COMMENT '单元标题',
  `description` varchar(500) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL DEFAULT NULL COMMENT '单元简介',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = ${COLLATION} ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `user`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `account` varchar(20) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NOT NULL,
  `nickname` varchar(50) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL DEFAULT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL DEFAULT NULL,
  `passwordHash` varchar(255) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NOT NULL,
  `avatarUrl` varchar(1024) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL DEFAULT NULL COMMENT '头像URL',
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = ${COLLATION} ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = ${COLLATION} COMMENT = '用户打卡记录表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = ${COLLATION} COMMENT = '用户打卡统计表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = ${COLLATION} ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = ${COLLATION} ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = ${COLLATION} ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `vocabulary`  (
  ...
  `word` varchar(100) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NOT NULL COMMENT '英文原词',
  `forms` varchar(500) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL DEFAULT NULL COMMENT '词形变化，逗号分隔，如 shadows,shadowed,shadowing',
  `phonetic` varchar(100) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL DEFAULT NULL COMMENT '音标，如 /ˈʃædoʊ/',
  `meaning` varchar(500) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NOT NULL COMMENT '中文释义',
  `exampleSentence` text CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL COMMENT '英文例句',
  `exampleTranslation` text CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL COMMENT '例句中文翻译',
...
) ENGINE = InnoDB AUTO_INCREMENT = 178 CHARACTER SET = utf8mb4 COLLATE = ${COLLATION} ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `word_bank`  (
  ...
  `phonetic` varchar(100) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL DEFAULT NULL COMMENT '音标，如 /ˈʃædoʊ/',
  `meaning` varchar(500) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NOT NULL COMMENT '中文释义',
  `forms` varchar(500) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL DEFAULT NULL COMMENT '词形变化，逗号分隔',
  `exampleSentence` text CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL COMMENT '英文例句',
  `exampleTranslation` text CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL COMMENT '例句中文翻译',
  `level` int NOT NULL COMMENT '难度: 1小学 2初中 3高中 4四级 5六级',
  `source` varchar(200) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL DEFAULT NULL COMMENT '来源，如人教版小学三年级上册',
  `frequency` int NOT NULL DEFAULT 0 COMMENT '词频/优先级，数字越大越常用',
  `tags` varchar(500) CHARACTER SET utf8mb4 COLLATE ${COLLATION} NULL DEFAULT NULL COMMENT '标签，如名词,动物,基础',
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `media_id` int NULL DEFAULT NULL COMMENT '关联的媒体资源ID (media.id)',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_word_level`(`word` ASC, `level` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 191 CHARACTER SET = utf8mb4 COLLATE = ${COLLATION} ROW_FORMAT = DYNAMIC;
